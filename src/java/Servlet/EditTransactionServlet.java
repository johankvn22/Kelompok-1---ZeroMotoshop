...
public class EditTransactionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatch = request.getRequestDispatcher("/views/edit_transaction.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            model.setTransaction_type(transaction_type);
            model.setJumlah(jumlah);
            model.setTransaction_date(transaction_date);

            TransactionController tc = new TransactionController();
            Boolean res = tc.update(id, model);
